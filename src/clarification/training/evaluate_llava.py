...
def generate_response(model, processor, image, system_prompt, user_prompt, max_length, cfg, prompt_type="ans"):
    ...
    # print(len(inputs["input_ids"].squeeze(0)))
...
def main(cfg: DictConfig): 
    ...
    max_length_key = f"{cfg.mode}_{cfg.env}"
    ...
    for split in cfg.splits:
        ...
        # for idx in tqdm(range(10), desc=f"Processing {split}"):
